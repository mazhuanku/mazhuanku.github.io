...
Blockly.Blocks['grove_led'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("LED")
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-LED1.jpg", 64, 64))
        .appendField("PIN#")
...
Blockly.Blocks['grove_button'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("开关")
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Button1.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN");
...
Blockly.Blocks['grove_rotary_angle'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Potentiometer1.jpg", 64, 64))
        .appendField("PIN#")
...
Blockly.Blocks['grove_tilt_switch'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Tilt1.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN");
    this.setOutput(true, 'Boolean');
...
Blockly.Blocks['grove_piezo_buzzer'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Buzzer1.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendField("stat")
        .appendField(new Blockly.FieldDropdown([["HIGH", "HIGH"], ["LOW", "LOW"]]), "STAT");
...
Blockly.Blocks['grove_relay'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Relay")
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Twig-Relay1.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendField("stat")
        .appendField(new Blockly.FieldDropdown([["HIGH", "HIGH"], ["LOW", "LOW"]]), "STAT");
...
Blockly.Blocks['grove_serial_lcd_print'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-LCD1.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN");
...
Blockly.Blocks['grove_lcd_rgb_print'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("RGB LCD")
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-LCD_RGB_backlight.jpg", 64, 64));
    this.appendValueInput("TEXT",'String')
        .setCheck('String')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("print line1");
...
Blockly.Blocks['grove_sound_sensor'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Twig-Sound-sensor.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.analog), "PIN")
    this.setOutput(true, 'Number');
...
Blockly.Blocks['grove_line_finder'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Grovelinefinder1.jpg", 64, 64))
	      .appendField("PIN#")
	      .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN");
    this.setOutput(true, 'Boolean');
...
Blockly.Blocks['grove_ultrasonic_ranger'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/200px-Twig_-_Ultrasonic_Ranger2.jpg", 64, 64))
	      .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendField("unit")
...
Blockly.Blocks['hc_sr04'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("../../blocks/grove/200px-Twig_-_Ultrasonic_Ranger2.jpg", 64, 64))
        .appendField("TrigPIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "TrigPIN")
        .appendField("EchoPIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "EchoPIN");
    this.setOutput(true, 'Boolean');
    this.setTooltip('Non-contact distance measurement module');
  }
};
...
/*Blockly.Blocks['hc_sr04'] = {
  ...
  init: function() {
    ...
    this.appendValueInput("C1")
        ...
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("TrigPin#")
        .appendField(new Blockly.FieldTextInput(''), 'TrigPin');
    this.appendValueInput("C2")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("EchoPin#")
        .appendField(new Blockly.FieldTextInput(''), 'EchoPin');
    this.setOutput(true, 'Boolean');
    this.setTooltip('Non-contact distance measurement module');
  }
};*/
...
Blockly.Blocks['grove_motor_shield'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Motor")
        .appendField(new Blockly.FieldImage("../../blocks/grove/400px-Smotoshield2.jpg", 64, 64))
...
Blockly.Blocks['grove_thumb_joystick'] = {
  ...
  init: function() {
	...
	.appendField("Thumb Joystick")
        .appendField(new Blockly.FieldImage("../../blocks/grove/200px-Twig_-_Thumb_Joystick_v0.9b.jpg", 64, 64))
	.appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.analog), "PIN")
        .appendField("axis")
...
Blockly.Blocks['Hc06_bluetooth'] = {
  category: 'Network',
  //helpUrl: 'http://www.seeedstudio.com/wiki/Grove_-_Serial_Bluetooth',
  init: function() {
    this.setColour(190);
    this.appendDummyInput()
      .appendField("Bluetooth HC06")
      .appendField(new Blockly.FieldImage("../../blocks/grove/hc06.jpeg", 64, 64))
      .appendField("Serial")
      .appendField(new Blockly.FieldDropdown([['', ''], ['1', '1'], ['2', '2'],['3', '3']]), "PIN");
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Name")
      .appendField(new Blockly.FieldTextInput('HC-06'), 'NAME');
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Pincode")
      .appendField(new Blockly.FieldTextInput('1234'), 'PINCODE');
    this.appendStatementInput("RCV")
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Receive");
    this.appendStatementInput("SNT")
...
Blockly.Blocks['Hc05_bluetooth'] = {
  category: 'Network',
  //helpUrl: 'http://www.seeedstudio.com/wiki/Grove_-_Serial_Bluetooth',
  init: function() {
    this.setColour(190);
    this.appendDummyInput()
      .appendField("Bluetooth HC05")
      .appendField(new Blockly.FieldImage("../../blocks/grove/hc06.jpeg", 64, 64))
      .appendField("Serial")
      .appendField(new Blockly.FieldDropdown([['', ''], ['1', '1'], ['2', '2'],['3', '3']]), "PIN")
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Name")
      .appendField(new Blockly.FieldTextInput('HC-05'), 'NAME');
    /*this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Pincode")
      .appendField(new Blockly.FieldTextInput('1234'), 'PINCODE');*/
...
Blockly.Blocks['CurieBLE'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
      .appendField("BLE")
      .appendField(new Blockly.FieldImage("../../blocks/grove/arduino101.jpg", 64, 64))
      .appendField("Serial")
      .appendField(new Blockly.FieldDropdown([['', ''], ['1', '1'], ['2', '2'],['3', '3']]), "PIN")
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Service")
      .appendField(new Blockly.FieldTextInput('HC-05'), 'Service');
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("UUID")
      .appendField(new Blockly.FieldTextInput('1234'), 'UUID');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Bluetooth V4.0 slave. Support single slave per board');
  }
};
