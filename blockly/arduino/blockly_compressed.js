...
goog.DEPENDENCIES_ENABLED && (goog.included_ = {}, goog.dependencies_ = {
    ...
    try {
        ...
        if (goog.moduleLoaderState_.declareTestMethods)for (var e in c)if (0 === e.indexOf("test", 0) || "tearDown" == e || "setUp" == e || "setUpPage" == e || "tearDownPage" == e) goog.global[e] = c[e]
    } finally {
    ...
    function a(e) {
        if (!(e in d.written)) {
            if (!(e in d.visited) &&
                (d.visited[e] = !0, e in d.requires))for (var f in d.requires[e])if (!goog.isProvided_(f))if (f in d.nameToPath) a(d.nameToPath[f]); else throw Error("Undefined nameToPath for " + f);
    ...
    goog.moduleLoaderState_ = null;
    for (f = 0; f < b.length; f++)if (e = b[f]) d.pathIsModule[e] ? goog.importModule_(goog.basePath + e) : goog.importScript_(goog.basePath +
        e); else throw goog.moduleLoaderState_ = g, Error("Undefined script input");
...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            var c = 0 == m[1].length ? 0 : parseInt(m[1], 10), n = 0 == p[1].length ? 0 : parseInt(p[1], 10),
...
goog.style.getOffsetParent = function (a) {
    ...
    for (a = a.parentNode; a && a != b; a = a.parentNode)if (a.nodeType == goog.dom.NodeType.DOCUMENT_FRAGMENT && a.host && (a = a.host), c = goog.style.getStyle_(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c ||
...
goog.style.getContainerOffsetToScrollInto = function (a, b, c) {
    var d = goog.style.getPageOffset(a), e = goog.style.getPageOffset(b), f = goog.style.getBorderBox(b),
        g = d.x - e.x - f.left, d = d.y - e.y - f.top, h = b.clientWidth - a.offsetWidth;
...
goog.async.nextTick.getSetImmediateEmulator_ = function () {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !goog.labs.userAgent.engine.isPresto() && (a = function () {
        ...
        var c = "callImmediate" + Math.random(), d = "file:" == b.location.protocol ? "*" :
            b.location.protocol + "//" + b.location.host, a = goog.bind(function (a) {
...
goog.Promise.resolve = function (a) {
    return a instanceof goog.Promise ? a : new goog.Promise(goog.Promise.RESOLVE_FAST_PATH_, a)
};
...
goog.Promise.all = function (a) {
    return new goog.Promise(function (b, c) {
        ...
        if (d)for (var f = function (a, c) {
            ...
            c(a)
        }, h = 0, k; k = a[h]; h++)goog.Promise.maybeThenVoid_(k, goog.partial(f, h), g); else b(e)
    })
};
goog.Promise.allSettled = function (a) {
    return new goog.Promise(function (b, c) {
        ...
        if (d)for (var f = function (a, c, f) {
            ...
            0 == d && b(e)
        }, g = 0, h; h = a[g]; g++)goog.Promise.maybeThenVoid_(h, goog.partial(f, g, !0), goog.partial(f, g, !1)); else b(e)
    })
};
goog.Promise.firstFulfilled = function (a) {
    return new goog.Promise(function (b, c) {
        ...
        if (d)for (var f = function (a) {
            ...
            e[a] = b;
            0 == d && c(e)
        }, h = 0, k; k = a[h]; h++)goog.Promise.maybeThenVoid_(k, f, goog.partial(g, h)); else b(void 0)
    })
};
...
goog.Promise.prototype.resolve_ = function (a, b) {
    if (this.state_ == goog.Promise.State_.PENDING) {
        if (this == b) a = goog.Promise.State_.REJECTED, b = new TypeError("Promise cannot resolve to itself"); else {
...
goog.events.KeyHandler.prototype.handleEvent = function (a) {
    ...
    goog.userAgent.IE && a.type == goog.events.EventType.KEYPRESS ? (c = this.keyCode_, d = c != goog.events.KeyCodes.ENTER && c != goog.events.KeyCodes.ESC ? b.keyCode : 0) : goog.userAgent.WEBKIT && a.type == goog.events.EventType.KEYPRESS ? (c = this.keyCode_, d = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(c) ? b.charCode : 0) : goog.userAgent.OPERA && !goog.userAgent.WEBKIT ? (c = this.keyCode_, d = goog.events.KeyCodes.isCharacterKey(c) ?
        b.keyCode : 0) : (c = b.keyCode || this.keyCode_, d = b.charCode || 0, goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (e = this.altKey_), goog.userAgent.MAC && d == goog.events.KeyCodes.QUESTION_MARK && c == goog.events.KeyCodes.WIN_KEY && (c = goog.events.KeyCodes.SLASH));
...
goog.color.hslToRgb = function (a, b, c) {
    var d = 0, e = 0, f = 0;
    a /= 360;
    if (0 == b) d = e = f = 255 * c; else var g = f = 0, g = .5 > c ? c * (1 + b) : c + b - b * c, f = 2 * c - g,
        d = 255 * goog.color.hueToRgb_(f, g, a + 1 / 3), e = 255 * goog.color.hueToRgb_(f, g, a),
...
goog.cssom.replaceCssRule = function (a, b, c, d) {
    if (c = c || goog.cssom.getParentStyleSheet(a))if (a = 0 <= d ? d : goog.cssom.getCssRuleIndexInParentStyleSheet(a, c), 0 <= a) goog.cssom.removeCssRule(c, a), goog.cssom.addCssRule(c, b, a); else throw Error("Cannot proceed without the index of the cssRule."); else throw Error("Cannot proceed without the parentStyleSheet.");
};
...
goog.cssom.addCssText = function (a, b) {
    var c = b ? b.getDocument() : goog.dom.getDocument(), d = c.createElement(goog.dom.TagName.STYLE);
    d.type = "text/css";
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    b ? (this.resizeGroup_ = Blockly.createSvgElement("g",
        {"class": this.workspace_.RTL ? "blocklyResizeSW" : "blocklyResizeSE"}, this.bubbleGroup_), c = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.createSvgElement("polygon", {points: "0,x x,x x,0".replace(/x/g, c.toString())}, this.resizeGroup_), Blockly.createSvgElement("line", {
...
Blockly.Bubble.prototype.resizeMouseMove_ = function (a) {
    this.autoLayout_ = !1;
    var b = this.resizeDeltaWidth, c = this.resizeDeltaHeight + a.clientY,
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), l = Math.cos(h), q = this.getBubbleSize(),
            h = (q.width + q.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, q.width, q.height) / 2,
            q = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b +
                q * d, e = c + q * e, q = b + h * l, m = c + h * k, b = b - h * l, c = c - h * k,
...
Blockly.Icon.prototype.createIcon = function () {
    this.iconGroup_ || (this.iconGroup_ = Blockly.createSvgElement("g", {"class": "blocklyIconGroup"}, null), Blockly.createSvgElement("image", {
        width: this.SIZE,
        height: this.SIZE
...
Blockly.Icon.prototype.computeIconLocation = function () {
    var a = this.block_.getRelativeToSurfaceXY(), b = Blockly.getRelativeXY_(this.iconGroup_),
        c = a.x + b.x + this.SIZE / 2, a = a.y + b.y + this.SIZE / 2;
...
Blockly.Comment.prototype.setVisible = function (a) {
    if (a != this.isVisible())if (!this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a); else {
...
Blockly.Connection.prototype.connect = function (a) {
    ...
    if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
        ...
        if (a.targetConnection) {
            ...
            for (var c = this.sourceBlock_; c = Blockly.Connection.singleConnection_(c, b);)if (c.targetBlock()) c = c.targetBlock(); else {
        ...
        if (a.targetConnection) {
            ...
            for (c = this.sourceBlock_; c.nextConnection;)if (c.nextConnection.targetConnection) c = c.getNextBlock(); else {
...
Blockly.Connection.prototype.checkType_ = function (a) {
    ...
    for (b = 0; b < this.check_.length; b++)if (-1 != a.check_.indexOf(this.check_[b]))return !0;
    return !1
};
...
Blockly.Field.prototype.init = function (a) {
    this.sourceBlock_ || (this.sourceBlock_ = a, this.fieldGroup_ = Blockly.createSvgElement("g", {}, null), this.visible_ || (this.fieldGroup_.style.display = "none"), this.borderRect_ = Blockly.createSvgElement("rect", {
        ...
        y: -12,
        height: 16
    }, this.fieldGroup_), this.textElement_ = Blockly.createSvgElement("text", {"class": "blocklyText"}, this.fieldGroup_), this.updateEditable(), a.getSvgRoot().appendChild(this.fieldGroup_), this.mouseUpWrapper_ = Blockly.bindEvent_(this.fieldGroup_,
...
Blockly.Tooltip.onMouseMove_ = function (a) {
    if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && 0 == Blockly.dragMode_ && !Blockly.WidgetDiv.isVisible())if (Blockly.Tooltip.visible) {
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
    ...
    if (!Blockly.isRightButton(a)) {
        var b = Blockly.mouseToSvg(a, this.workspace_.options.svg), b = this.horizontal_ ? b.x : b.y,
            c = Blockly.getSvgXY_(this.svgKnob_), c = this.horizontal_ ? c.x : c.y,
...
Blockly.Xml.blockToDom_ = function (a) {
    ...
    for (var c = 0, d; d = a.inputList[c]; c++)for (var e = 0, f; f = d.fieldRow[e]; e++)if (f.name && f.EDITABLE) {
...
Blockly.Xml.domToWorkspace = function (a, b) {
    ...
    for (var d = b.childNodes.length, e = 0; e < d; e++) {
        ...
        if ("block" == f.nodeName.toLowerCase()) {
            var g = Blockly.Xml.domToBlock(a, f), h = parseInt(f.getAttribute("x"), 10),
...
Blockly.Xml.domToBlockHeadless_ = function (a, b, c) {
    var d = null, e = b.getAttribute("type");
    ...
    for (var g = null, f = 0, h; h = b.childNodes[f]; f++)if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
        ...
        switch (h.nodeName.toLowerCase()) {
            ...
            case "statement":
                ...
                if (g && "block" == g.nodeName.toLowerCase())if (g = Blockly.Xml.domToBlockHeadless_(a, g, c), g.outputConnection) h.connection.connect(g.outputConnection); else if (g.previousConnection) h.connection.connect(g.previousConnection); else throw"Child block does not have output or previous statement.";
                break;
            case "next":
...
Blockly.WorkspaceSvg.prototype.paste = function (a) {
    if (this.rendered && !(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
        ...
        var b = Blockly.Xml.domToBlock(this, a), c = parseInt(a.getAttribute("x"), 10);
        a = parseInt(a.getAttribute("y"), 10);
        if (!isNaN(c) && !isNaN(a)) {
            this.RTL && (c = -c);
            do {
                for (var d = !1, e = this.getAllBlocks(), f = 0, g; g = e[f]; f++)if (g = g.getRelativeToSurfaceXY(), 1 >= Math.abs(c - g.x) && 1 >= Math.abs(a - g.y)) {
                    d = !0;
                    break
                }
                if (!d)for (e = b.getConnections_(!1), f = 0; g = e[f]; f++)if (g.closest(Blockly.SNAP_RADIUS,
                        c, a).connection) {
                    d = !0;
                    break
                }
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    if (!this.options.readOnly) {
        ...
        if (this.options.collapse) {
            for (var c = !1, d = !1, e = this.getTopBlocks(!1), f = 0; f < e.length; f++)for (var g = e[f]; g;)g.isCollapsed() ? c = !0 : d = !0, g = g.getNextBlock();
            d = {enabled: d};
            d.text = Blockly.Msg.COLLAPSE_ALL;
            d.callback = function () {
                for (var a = 0, b = 0; b < e.length; b++)for (var c = e[b]; c;)setTimeout(c.setCollapsed.bind(c, !0), a), c = c.getNextBlock(), a += 10
            };
            b.push(d);
            c = {enabled: c};
            ...
            c.callback = function () {
                for (var a =
                    0, b = 0; b < e.length; b++)for (var c = e[b]; c;)setTimeout(c.setCollapsed.bind(c, !1), a), c = c.getNextBlock(), a += 10
            };
            b.push(c)
        }
...
Blockly.Mutator.prototype.resizeBubble_ = function () {
    var a = 2 * Blockly.Bubble.BORDER_WIDTH, b = this.workspace_.getCanvas().getBBox(),
        c = this.workspace_.flyout_.getMetrics_(), d;
...
Blockly.Mutator.prototype.workspaceChanged_ = function () {
    if (0 == Blockly.dragMode_)for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++) {
...
Blockly.Block.prototype.setEditable = function (a) {
    ...
    if (this.rendered)for (b = this.getIcons(), a = 0; a < b.length; a++)b[a].updateEditable()
};
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
    var d = Blockly.tokenizeInterpolation(a), e = [], f = 0;
    a = [];
    ...
    d = [];
    for (g = 0; g < a.length; g++)if (e = a[g], "string" == typeof e) d.push([e, void 0]); else {
        b = f = null;
        ...
        if (f) d.push([f, e.name]); else if (b) {
...
Blockly.ContextMenu.show = function (a, b, c) {
    ...
    if (b.length) {
        ...
        var g = goog.style.getSize(h), e = a.clientX + f.x, k = a.clientY + f.y;
...
Blockly.BlockSvg.prototype.onMouseUp_ = function (a) {
    ...
    Blockly.doCommand(function () {
        Blockly.terminateDrag_();
        if (Blockly.selected && Blockly.highlightedConnection_) Blockly.localConnection_.connect(Blockly.highlightedConnection_), b.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).sourceBlock_.connectionUiEffect(), b.workspace.trashcan && b.workspace.trashcan.close(); else if (Blockly.selected.isDeletable() && b.workspace.isDeleteArea(a)) {
    ...
    if (!this.workspace.options.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
            ...
            this.workspace.options.collapse && (this.collapsed_ ? (d =
                {enabled: !0}, d.text = Blockly.Msg.EXPAND_BLOCK, d.callback = function () {
                b.setCollapsed(!1)
            ...
            d = {
                text: 1 == d ? Blockly.Msg.DELETE_BLOCK :
                    Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(d)), enabled: !0, callback: function () {
                    b.dispose(!0, !0)
                }
            };
            c.push(d)
    ...
    Blockly.doCommand(function () {
        if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            ...
            if (2 == Blockly.dragMode_) {
                var e = b.startDragX + c, f = b.startDragY +
                    d;
...
Blockly.BlockSvg.prototype.updateColour = function () {
    if (!this.disabled) {
        var a = Blockly.makeColour(this.getColour()), b = goog.color.hexToRgb(a), c = goog.color.lighten(b, .3),
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), q = 0, m; m = b[q]; q++)if (m.isVisible()) {
        var p;
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
    ...
    var d = this.getRelativeToSurfaceXY(), e = [], f = [], c = [], g = [];
...
Blockly.FieldTextInput.prototype.showEditor_ = function (a) {
    var b = a || !1;
    if (!b && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)) a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_), this.sourceBlock_ && this.changeHandler_ && (b = this.changeHandler_(a), void 0 !== b && (a = b)), null !== a && this.setText(a); else {
...
Blockly.FieldAngle.prototype.setChangeHandler = function (a) {
    ...
    if (a) {
        ...
        b = function (b) {
            var e = a.call(c, b);
            if (null === e)var f = e; else void 0 === e && (e = b), f = Blockly.FieldAngle.angleValidator.call(c, e), void 0 !== f && (f = e);
            return f === b ? void 0 : f
        }
...
Blockly.Variables.allVariables = function (a) {
    var b;
    if (a.getDescendants) b = a.getDescendants(); else if (a.getAllBlocks) b = a.getAllBlocks(); else throw"Not Block or Workspace: " + a;
...
Blockly.FieldVariable.prototype.setChangeHandler = function (a) {
    ...
    if (a) {
        ...
        b = function (b) {
            var e = a.call(c, b);
            if (null === e)var f = e; else void 0 === e && (e = b), f = Blockly.FieldVariable.dropdownChange.call(c, e), void 0 !== f && (f = e);
            return f === b ? void 0 : f
        }
...
var rtclient = {
    ...
    getParams: function () {
        ...
        var b = goog.global.location || {}, c = {}, d = b.hash;
        d && a(d);
        (b = b.search) && a(b);
        return c
    }
...
rtclient.Authorizer.prototype.authorize = function (a) {
    var b = this.clientId, c = this.userId, d = this, e = function (b) {
    ...
    gapi.auth.authorize({
        client_id: b, scope: [rtclient.INSTALL_SCOPE,
            rtclient.FILE_SCOPE, rtclient.OPENID_SCOPE, rtclient.APPDATA_SCOPE], user_id: c, immediate: !0
    }, e)
};
...
rtclient.createRealtimeFile = function (a, b, c, d) {
    function e(c) {
        gapi.client.drive.files.insert({resource: {mimeType: b, title: a, parents: [{id: c}]}}).execute(d)
    }
...
rtclient.RealtimeLoader.prototype.load = function () {
    ...
    a && (a = a.split(","));
    var b = this.authorizer.userId, b = rtclient.params.state;
    if (a)for (var c in a)gapi.drive.realtime.load(a[c], this.onFileLoaded, this.initializeModel, this.handleErrors); else {
...
Blockly.Realtime.logEvent_ = function (a) {
    ...
    if (a = a.events)for (var b = a.length, c = 0; c < b; c++) {
        var d = a[c];
...
Blockly.Realtime.addAuthUi_ = function (a) {
    ...
    var b = goog.style.getBounds(a), c = goog.dom.createDom("div");
...
Blockly.Realtime.updateCollabUi_ = function () {
    if (Blockly.Realtime.collabElementId) {
        ...
        for (var b = Blockly.Realtime.document_.getCollaborators(), c = 0; c < b.length; c++) {
            var d = b[c], e = goog.dom.createDom("img", {
...
Blockly.Flyout.prototype.wheel_ = function (a) {
    ...
    if (b) {
        ...
        var c = this.getMetrics_(), b = c.viewTop + b, b = Math.min(b, c.contentHeight - c.viewHeight),
            b = Math.max(b, 0);
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    else for (var h = 0; d = a[h]; h++)d.tagName && "BLOCK" == d.tagName.toUpperCase() && (d = Blockly.Xml.domToBlock(this.workspace_, d), b.push(d), g.push(3 * f));
    a = f;
    for (h = 0; d = b[h]; h++) {
        c = d.getDescendants();
        e = 0;
...
Blockly.Toolbox.prototype.position = function () {
    var a = this.HtmlDiv;
    if (a) {
        var b = this.workspace_.options.svg, c = goog.style.getPageOffset(b), b = Blockly.svgSize(b);
...
Blockly.Toolbox.prototype.populate_ = function (a) {
    function b(a, e) {
        for (var f = 0, g; g = a.childNodes[f]; f++)if (g.tagName)switch (g.tagName.toUpperCase()) {
            case "CATEGORY":
...
Blockly.inject = function (a, b) {
    ...
    var c = Blockly.parseOptions_(b || {}), d, e = function () {
...
Blockly.parseOptions_ = function (a) {
    ...
    if (b)var c = null, d = !1, e = !1, f = !1, g = !1, h = !1,
        k = !1; else c = Blockly.parseToolboxTree_(a.toolbox), d = Boolean(c && c.getElementsByTagName("category").length), e = a.trashcan, void 0 === e && (e = d), f = a.collapse, void 0 === f && (f = d), g = a.comments, void 0 === g && (g = d), h = a.disable, void 0 === h && (h = d), k = a.sounds, void 0 === k && (k = !0);
    var l = a.scrollbars;
    void 0 === l && (l = d);
    var q = a.css;
    void 0 === q && (q = !0);
...
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.createSvgElement("svg", {
        ...
        version: "1.1",
        "class": "blocklySvg"
    }, a), d = Blockly.createSvgElement("defs", {}, c), e, f;
    ...
    d = Blockly.createSvgElement("pattern", {
        id: "blocklyGridPattern" + String(Math.random()).substring(2), patternUnits: "userSpaceOnUse",
        width: e, height: e
    }, d);
    ...
    b.readOnly || b.hasScrollbars || c.addChangeListener(function () {
        if (0 == Blockly.dragMode_) {
            ...
            if (a.contentTop < f || a.contentTop + a.contentHeight > a.viewHeight + f || a.contentLeft < (b.RTL ?
                    a.viewLeft : e) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + e))for (var g = c.getTopBlocks(!1), h = 0, k; k = g[h]; h++) {
                var l = k.getRelativeToSurfaceXY(), q = k.getHeightWidth(), m = f + 25 - q.height - l.y;
                0 < m && k.moveBy(0, m);
...
Blockly.init_ = function (a) {
    ...
    if (b.languageTree)if (a.toolbox_) a.toolbox_.init(a); else if (a.flyout_) {
        a.flyout_.init(a);
...
Blockly.svgResize = function (a) {
    ...
    var b = a.options.svg, c = b.parentNode;
    if (c) {
...
Blockly.onKeyDown_ = function (a) {
    if (!Blockly.isTargetInput_(a))if (27 == a.keyCode) Blockly.hideChaff(); else if (8 == a.keyCode || 46 == a.keyCode)try {
...
Blockly.getMainWorkspaceMetrics_ = function () {
    ...
    if (this.scrollbar)var f = this.RTL ? 0 : Blockly.Scrollbar.scrollbarThickness,
        ...
        b = Math.max(d.x + d.width + b / 2, d.x + b + f - 5), f = Math.min(d.y - c / 2,
            d.y + d.height - c + 5),
        c = Math.max(d.y + d.height + c / 2, d.y + c + Blockly.Scrollbar.scrollbarThickness - 5); else g = d.x, b = g + d.width, f = d.y, c = f + d.height;
    d = 0;
