...
Blockly.Arduino.grove_lcd_rgb_print = function() {
  ...
  Blockly.Arduino.definitions_['define_lcd_rgb'] = '#include <rgb_lcd.h>\n';
...
Blockly.Arduino.hc_sr04 = function() {
  var dropdown_pin_c1 = this.getFieldValue('TrigPIN');
  var dropdown_pin_c2 = this.getFieldValue('EchoPIN');
  //Blockly.Arduino.setups_['setup_TrigPin'+dropdown_pin_c1] = 'pinMode('+dropdown_pin_c1+', OUTPUT);';
  //Blockly.Arduino.setups_['setup_EchoPin'+dropdown_pin_c2] = 'pinMode('+dropdown_pin_c2+', INPUT);';
  Blockly.Arduino.definitions_['define_ultrasonic'] = '#include <UltraDistSensor.h>\n';

  Blockly.Arduino.definitions_['distance_sensor'] = 'UltraDistSensor distance;';

  Blockly.Arduino.setups_['setup_distance_sensor'] = 'distance.attach('+dropdown_pin_c1+','+dropdown_pin_c2+');';


  var code = 'distance.distanceInCm()';
...
Blockly.Arduino.grove_rgb_led = function() {
  ...
  var code = 'analogWrite('+dropdown_pin_C1+',255-'+dropdown_stat_C1+');\n';
   code   +='analogWrite('+dropdown_pin_C2+',255-'+dropdown_stat_C2+');\n';
   code  +='analogWrite('+dropdown_pin_C3+',255-'+dropdown_stat_C3+');\n';
  return code;
};
...
Blockly.Arduino.Hc06_bluetooth = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var NextPIN = _get_next_pin(dropdown_pin);
  var name = this.getFieldValue('NAME')
  var pincode = this.getFieldValue('PINCODE');
  ...
  Blockly.Arduino.definitions_['define_setupBlueToothConnection_'+dropdown_pin] = 'void setupBlueToothConnection_'+dropdown_pin+'()\n'+
  '{\n'+
  '  Serial'+dropdown_pin+'.begin(9600); 	\n'+
  '  Serial'+dropdown_pin+'.print("AT"); 	\n'+
  '  delay(1000); 	\n'+
  '  Serial'+dropdown_pin+'.print("AT+NAME'+name+'"); \n'+
  '  delay(1000); \n'+
  '  Serial'+dropdown_pin+'.print("AT+PIN'+pincode+'");	\n'+
  '  delay(1000);\n'+
  ...
  '  delay(1000); // This delay is required.;\n'+*/
  '  Serial'+dropdown_pin+'.flush();\n'+
  '}\n';

  var code = 'char val;\n'+
  '  if(Serial'+dropdown_pin+'.available()) {\n'+
  '    val = Serial'+dropdown_pin+'.read();\n'+
  '    Serial.print(val);\n'+
       statement_receive+
  '  }\n'+
  '  if(Serial.available()){\n'+
  '    val = Serial.read();\n'+
  '    Serial'+dropdown_pin+'.print(val);\n'+
       statement_send+
  '  }\n';
  return code;
};

Blockly.Arduino.Hc05_bluetooth = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var NextPIN = _get_next_pin(dropdown_pin);
  var name = this.getFieldValue('NAME')
  var pincode = this.getFieldValue('PINCODE');
  ...
  Blockly.Arduino.definitions_['define_setupBlueToothConnection_'+dropdown_pin] = 'void setupBlueToothConnection_'+dropdown_pin+'()\n'+
  '{\n'+
  '  Serial'+dropdown_pin+'.begin(38400); 	\n'+
  '  Serial'+dropdown_pin+'.println("AT"); 	\n'+
  '  delay(1000); 	\n'+
  '  Serial'+dropdown_pin+'.println("AT+NAME='+name+'"); \n'+
  '  delay(1000); \n'+
  /*'  Serial'+dropdown_pin+'.println("AT+PSWD='+pincode+'");	\n'+
  '  delay(1000);\n'+*/
  /*'  blueToothSerial_'+dropdown_pin+'.print("AT+PIN'+pincode+'");		//Set SLAVE pincode"'+pincode+'";\n'+
  '  delay(1000); // This delay is required.;\n'+
  '  blueToothSerial_'+dropdown_pin+'.print("AT+AUTH1"); // Permit Paired device to connect me;\n'+
...
Blockly.Arduino.CurieBLE = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var NextPIN = _get_next_pin(dropdown_pin);
  var name = this.getFieldValue('NAME')
  var pincode = this.getFieldValue('PINCODE');
  ...
  '  Serial'+dropdown_pin+'.println("AT"); 	\n'+
  '  delay(1000); 	\n'+
  '  Serial'+dropdown_pin+'.write("AT+NAME'+name+'"); \n'+
  '  delay(1000); \n'+
  '  Serial'+dropdown_pin+'.print("AT+PIN'+pincode+'");	\n'+
  '  delay(1000);\n'+
  /*'  blueToothSerial_'+dropdown_pin+'.print("AT+PIN'+pincode+'");		//Set SLAVE pincode"'+pincode+'";\n'+
